...
Copied from and maintained as part of the MESSAGEix framework
https://github.com/iiasa/message_ix/blob/main/message_ix/util/sphinx_gams.py
...
"License"); you may not use the files in this repository except in compliance with the
License. You may obtain a copy of the License in LICENSE or at
...
def transcribe_docs(infp, outfp, source_filename):
    ...
    for line in infp:
        if line.lstrip().startswith("***"):
            ...
            base = line.removeprefix("*").removeprefix(" ")
